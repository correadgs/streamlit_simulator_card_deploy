...
csv_files = {
    "Pag Seguro": {
        "Visa": r"dataset\Maquina 1 - Visa.CSV",
        "Master": r"dataset\Maquina 1 - Master.CSV",
        "Diners": r"dataset\Maquina 1 - Diners.CSV",
        "Demais": r"dataset\Maquina 1 - Demais.CSV",
        "Link": "rdataset\Maquina 1 - Link.CSV",
    },
    "Infinity": {
        "Visa": r"dataset\Maquina 2 - Visa.CSV",
        "Master": r"dataset\Maquina 2 - Master.CSV",
        "Demais": r"dataset\Maquina 2 - Demais.CSV",
    }
}
